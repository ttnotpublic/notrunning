window.skins={};
	...
	_proto.grpTopMenu_SubMenu_i = function () {
		...
		t.x = 430;
		t.y = 78;
		t.elementsContent = [this._Image14_i(),this.txtAdsBidding_i(),this.txtDividends_i(),this.txtFAQ_i(),this.txtContact_i(),this._Group2_i()];
		return t;
	};
	_proto._Image14_i = function () {
		var t = new eui.Image();
	...
	_proto._Group2_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.bt_adword_i(),this.bt_getBonus_i(),this.bt_help_i(),this.bt_contact_i()];
		return t;
	};
